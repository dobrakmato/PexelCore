...
public class TntMinecartArena extends AdvancedMinigameArena
{
    ...
    private final Team             redTeam        = new Team(Color.RED, "Red team", 12);
    private final Team             blueTeam       = new Team(Color.BLUE, "Blue team", 12);
    ...
    public void onGameStart()
    {
        ...
        this.minecart = (ExplosiveMinecart) this.getWorld().spawnEntity(
                this.minecartSpawn, EntityType.MINECART_TNT);
    ...
    protected void checkMinecart()
    {
        ...
        List<Entity> entities = this.minecart.getNearbyEntities(this.minecartRadius,
                this.minecartRadius, this.minecartRadius);
