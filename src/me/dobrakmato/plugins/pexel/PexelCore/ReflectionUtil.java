...
public abstract class ReflectionUtil
{
	...
	private static boolean equalsTypeArray(final Class<?>[] a,
			final Class<?>[] o)
	{
	...
	public static Class<?> getClass(final String name,
			final DynamicPackage pack, final String subPackage)
			throws Exception
	{
		return Class.forName(pack
				+ (subPackage != null && subPackage.length() > 0 ? "."
						+ subPackage : "") + "." + name);
	}
	...
	public static Object newInstance(final Class<?> clazz, final Object... args)
			throws Exception
	{
		return getConstructor(clazz, toPrimitiveTypeArray(args)).newInstance(
				args);
	}
	...
	public static Object newInstance(final String name,
			final DynamicPackage pack, final Object... args) throws Exception
	{
	...
	{
		return getMethod(name, clazz, toPrimitiveTypeArray(args)).invoke(obj,
				args);
	}
	...
	public static Object getValue(final String name, final Object obj)
			throws Exception
	{
