...
public final class ReflectionHandler
{
	...
	public static Constructor<?> getConstructor(final String className,
			final PackageType type, final Class<?>... parameterTypes)
			throws Exception
	{
	...
	public static Object newInstance(final Class<?> clazz, final Object... args)
			throws Exception
	{
		return getConstructor(clazz, DataType.convertToPrimitive(args)).newInstance(
				args);
	}
	
	public static Object newInstance(final String className,
			final PackageType type, final Object... args) throws Exception
	{
		return newInstance(getClass(className, type), args);
	}
	
	public static Object newInstance(final String className,
			final SubPackageType type, final Object... args) throws Exception
	{
		return newInstance(getClass(className, type), args);
	}
	...
	public static Method getMethod(final String className,
			final PackageType type, final String name,
	...
	public static Method getMethod(final String className,
			final SubPackageType type, final String name,
			final Class<?>... parameterTypes) throws Exception
	{
		return getMethod(getClass(className, type), name, parameterTypes);
	}
	...
	public static Object invokeMethod(final String className,
			final PackageType type, final String name, final Object instance,
			final Object... args) throws Exception
	{
	...
	public static Field getField(final String className,
			final PackageType type, final String name) throws Exception
	{
	...
	public static Object getValue(final String className,
			final PackageType type, final Object instance,
			final String fieldName) throws Exception
	{
	...
	public static Object getValue(final String className,
			final SubPackageType type, final Object instance,
			final String fieldName) throws Exception
	{
		return getValue(getClass(className, type), instance, fieldName);
	}
	
	public static Object getDeclaredValue(final Object instance,
			final String fieldName) throws Exception
	{
		return getDeclaredField(instance.getClass(), fieldName).get(instance);
	}
	
	public static Object getDeclaredValue(final Class<?> clazz,
	...
	public static void setValue(final String className,
			final SubPackageType type, final Object instance,
			final String fieldName, final Object fieldValue) throws Exception
	{
		setValue(getClass(className, type), instance, fieldName, fieldValue);
	...
	public static void setValues(final Object instance,
	...
	public static void setValues(final String className,
			final PackageType type, final Object instance,
			final FieldPair... pairs) throws Exception
	{
	...
	public static void setDeclaredValue(final Class<?> clazz,
			final Object instance, final String fieldName,
			final Object fieldValue) throws Exception
	{
	...
	public static void setDeclaredValue(final String className,
			final PackageType type, final Object instance, final FieldPair pair)
			throws Exception
	{
	...
	public static void setDeclaredValues(final Object instance,
			final FieldPair... pairs) throws Exception
	{
		for (FieldPair pair : pairs)
	...
	public static void setDeclaredValues(final Class<?> clazz,
	...
	public enum DataType
	{
		...
		public static boolean equalsArray(final Class<?>[] a1,
				final Class<?>[] a2)
		{
	...
	public enum SubPackageType
	{
		...
		{
			this.name = PackageType.CRAFTBUKKIT + "."
