 ...
 */
// @formatter:on
package eu.matejkormuth.pexel.slave.matchmaking;
...
import eu.matejkormuth.pexel.slave.core.Party;
import eu.matejkormuth.pexel.slave.core.StorageEngine;
import eu.matejkormuth.pexel.slave.core.Updatable;
import eu.matejkormuth.pexel.slave.core.UpdatedParts;
import eu.matejkormuth.pexel.slave.minigame.Minigame;
import eu.matejkormuth.pexel.slave.util.ServerLocation;
import eu.matejkormuth.pexel.slave.util.ServerLocationType;
...
public class Matchmaking implements Updatable {
    ...
    public static final class JSONArena {
        public String   name;
