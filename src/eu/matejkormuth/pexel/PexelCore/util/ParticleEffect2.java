...
public enum ParticleEffect2 {
     ...
     */
    private static boolean isLongDistance(final Location location,
     ...
     */
    public void display(final float offsetX, final float offsetY, final float offsetZ,
            final float speed, final int amount, final Location center,
            final double range) throws ParticleVersionException, ParticleDataException,
        ...
        if (this.requiresWater && !isWater(center)) { throw new IllegalArgumentException(
    ...
    public void display(final float offsetX, final float offsetY, final float offsetZ,
            final float speed, final int amount, final Location center,
            final List<Player> players) throws ParticleVersionException,
    ...
    public void display(final float offsetX, final float offsetY, final float offsetZ,
            final float speed, final int amount, final Location center,
            final Player... players) throws ParticleVersionException,
            ParticleDataException, IllegalArgumentException {
     ...
     * @see ParticlePacket#sendTo(Location, double)
     */
    public void display(final Vector direction, final float speed,
            final Location center, final double range) throws ParticleVersionException,
            ParticleDataException, IllegalArgumentException {
        if (!this.isSupported()) { throw new ParticleVersionException(
                "This particle effect is not supported by your server version"); }
        if (this.requiresData) { throw new ParticleDataException(
     ...
     */
    public void display(final Vector direction, final float speed,
            final Location center, final List<Player> players)
     ...
     */
    public void display(final Vector direction, final float speed,
            final Location center, final Player... players)
            throws ParticleVersionException, ParticleDataException,
            IllegalArgumentException {
     ...
     * @see ParticlePacket#sendTo(Location, double)
     */
    public void display(final ParticleData data, final Vector direction,
            final float speed, final Location center, final double range)
            throws ParticleVersionException, ParticleDataException {
        if (!this.isSupported()) { throw new ParticleVersionException(
                "This particle effect is not supported by your server version"); }
        if (!this.requiresData) { throw new ParticleDataException(
     ...
     */
    public void display(final ParticleData data, final Vector direction,
            final float speed, final Location center, final List<Player> players)
            throws ParticleVersionException, ParticleDataException {
        if (!this.isSupported()) { throw new ParticleVersionException(
                "This particle effect is not supported by your server version"); }
        if (!this.requiresData) { throw new ParticleDataException(
     ...
     */
    public void display(final ParticleData data, final Vector direction,
            final float speed, final Location center, final Player... players)
            throws ParticleVersionException, ParticleDataException {
    ...
    public static final class BlockData extends ParticleData {
        ...
        public BlockData(final Material material, final byte data)
                throws IllegalArgumentException {
            super(material, data);
            if (!material.isBlock()) { throw new IllegalArgumentException(
    ...
    public static final class ParticlePacket {
        ...
        public static void initialize() throws VersionIncompatibleException {
            ...
            try {
                version = Integer.parseInt(Character.toString(PackageType.getServerVersion()
                        .charAt(3)));
                if (version > 7) {
                ...
                getHandle = ReflectionUtil.getMethod("CraftPlayer",
        ...
        public void sendTo(final Location center, final Player player)
                ...
                try {
                    ...
                    if (version < 8) {
                        id = this.effect.getName()
                                + (this.data == null ? ""
                                        : this.data.getPacketDataString());
                    }
                    else {
                        id = enumParticle.getEnumConstants()[this.effect.getId()];
                    }
                    ReflectionUtil.setValue(this.packet, true, "a", id);
                    ReflectionUtil.setValue(this.packet, true, "b",
                            (float) center.getX());
                    ReflectionUtil.setValue(this.packet, true, "c",
                            (float) center.getY());
                    ReflectionUtil.setValue(this.packet, true, "d",
                            (float) center.getZ());
                    ReflectionUtil.setValue(this.packet, true, "e", this.offsetX);
                    ReflectionUtil.setValue(this.packet, true, "f", this.offsetY);
                    ReflectionUtil.setValue(this.packet, true, "g", this.offsetZ);
                    ReflectionUtil.setValue(this.packet, true, "h", this.speed);
                    ReflectionUtil.setValue(this.packet, true, "i", this.amount);
                    if (version > 7) {
                        ReflectionUtil.setValue(this.packet, true, "j",
                                this.longDistance);
                        ReflectionUtil.setValue(
                                this.packet,
                                true,
                                "k",
                                this.data == null ? new int[0]
                                        : this.data.getPacketData());
                    }
                } catch (Exception exception) {
            ...
            try {
                ...
                throw new PacketSendingException("Failed to send the packet to player '"
         ...
         *            Center location of the effect
         * @param range
         *            Range in which players will receive the packet (Maximum range for particles is usually 16, but it
        ...
        private static final class VersionIncompatibleException extends RuntimeException {
             ...
             *            Cause of the exception
             */
            public VersionIncompatibleException(final String message,
